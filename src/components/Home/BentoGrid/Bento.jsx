...
const Index = () => {
  return (
    <div className="bg-[#09090B] h-full w-full mx-auto text-white z-[5]">
      <div className="flex flex-col md:flex-row justify-center max-w-[1280px] gap-8 mx-auto py-8">
        ...
        {/* Right Section */}
        <div className="flex flex-col z-[5]">
          <div className="flex w-[262px] h-[164px] pt-[32px] pr-[32px] pb-[32px] pl-[32px] flex-col justify-center items-start flex-nowrap bg-[#31316433] bg-no-repeat rounded-[24px]  z-[44]">
            <div className="bg-[#2a2a6f33] p-2 rounded-md">
              <button className="md:flex items-center gap-2 bg-gradient-to-r from-purple-500 to-pink-500 px-8 py-2 rounded-md text-white text-lg flex ">
                <img src="/assets/images/image_icon.png" className="w-6 h-6" />{" "}
                Generate
          ...
          <div className="flex w-[262px] h-[220px] pt-[34px] pr-[32px] pb-[30px] pl-[32px] flex-col mt-8 gap-[20px] justify-center items-center flex-nowrap bg-[#31316433] bg-no-repeat rounded-[24px] z-[34]">
            <div className="flex flex-col gap-[12px] items-center self-stretch shrink-0 flex-nowrap relative z-[35]">
              ...
              <span className="flex w-[103px] h-[13px] mt-4 justify-center items-end shrink-0 font-['Plus_Jakarta_Sans'] text-[18px] font-normal leading-[13px] text-[#b1a0fc] relative text-center whitespace-nowrap z-[37] px-4 py-2">
                Created Prompt
              </span>
            </div>
          </div>

          <div className="flex mt-8 w-[262px] h-[396px] pt-[32px] pr-[32px] pb-[32px] pl-[32px] flex-col justify-between items-start flex-nowrap bg-[#31316433]  bg-no-repeat rounded-[24px]  z-[27]">
            <div className="flex flex-col gap-[20px] items-start self-stretch shrink-0 flex-nowrap relative z-[28]">
              <span className="flex w-[198px]  justify-start items-start self-stretch shrink-0 font-['Plus_Jakarta_Sans'] text-[22px] font-semibold leading-[10px] tracking-[-0.36px] relative text-left z-30">
                Prompt templates
              </span>
            ...
            <div className="w-[206px] h-[261.755px] shrink-0 relative overflow-hidden z-[3]  rounded-lg p-4">
              <div className="flex flex-col items-center justify-center gap-4">
                <div className="w-[120px] h-[30px] flex items-center justify-center bg-[rgba(98,106,181,0.21)] rounded-md border border-[rgba(255,255,255,0.05)] -rotate-45 mt-10 -right-3">
                ...
                <img
                  ...
                  alt=""
                  className="w-12 h-12 bg-[rgba(255,255,255,0.1)] p-1 rounded-full -ml-40"
                />

                <div className="flex gap-2 w-48 h-10 justify-center rounded-xl bg-[rgba(98,106,181,0.18)] rotate-90 -mt-16 ml-44">
                  <button className="flex items-center gap-2 justify-center  rounded-md  text-[#ddd6ff] uppercase text-[14px] font-medium">
                ...
                <img
                  ...
                  alt=""
                  className="w-12 h-12 bg-[rgba(255,255,255,0.1)] p-1 rounded-full -mt-10"
                />

                <button className="flex gap-2 items-center justify-center w-28 h-12 bg-[rgba(255,255,255,0.1)] rounded-full text-[#d4ccff] text-[16px] font-medium">
                  <img
