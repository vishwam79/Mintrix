    ...
    <div className=" h-full  w-full mx-auto text-white z-[5]">
      <div className="flex flex-col md:flex-row justify-center max-w-[1280px] gap-8 mx-auto py-8">
        ...
        <div className="flex flex-col z-[5]">
          ...
          <div className="flex sm:w-full mt-8 lg:max-w-[340px]  h-[396px] pt-[32px] pr-[32px] pb-[32px] pl-[32px] flex-col justify-between items-start flex-nowrap bg-[#31316433]  bg-no-repeat rounded-[24px]  z-[27]">
            <div className="flex w-auto flex-col gap-[20px] items-start self-stretch shrink-0 flex-nowrap relative z-[28]">
              <span className="flex w-full justify-start items-start self-stretch shrink-0 font-['Plus_Jakarta_Sans'] text-[32px] font-semibold leading-[20px] tracking-[-0.32px] relative text-left z-30">
                Prompt templates
              </span>
            ...
            <div className="w-auto h-[261.755px] shrink-0 relative overflow-hidden z-[3]  rounded-lg p-4">
              <div className="flex flex-col items-center justify-center gap-4">
                ...
                <img
                  ...
                  alt=""
                  className="w-12 h-12 bg-[rgba(255,255,255,0.1)] p-1 rounded-full -ml-56"
                />

                <div className="flex min-w-fit px-2 gap-2 h-10 justify-center rounded-xl bg-[rgba(98,106,181,0.18)] rotate-90 -mt-16 ml-40">
